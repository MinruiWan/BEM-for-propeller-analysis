function [Thrust, Fq] = Bladeloading2(N_section, R_tip, R_root, section_data,...
    ...
    for j = 1:1:N_section
        ...
        % Thrust extracted by each rotor annulus
        dT = 4*pi*r*rho*Uinf^2*(1-a1)*a1*dr;
        dFq = 4*pi*r^3*rho*Uinf*Omega*(1-a1)*a2*dr;
